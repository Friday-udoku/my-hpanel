  ...
  return (
    ...
    { <PrivatePageLink mode={Modals} className='fixed top-0'/>}
        ...
        <Container className=' fluid minutes-pages'>
            ...
            <h2 className='minutes-title'><strong> Minutes for September  </strong></h2>
            ...
            <p><strong>Charity status:</strong> Ugo expressed his thanks to all that participated at the the relay for life event and explained this is one of the reasons we have to complete our step in getting the Charity status.
            ...
            <p>
              <strong>Banks/Finacial Update:</strong> During the meeting, the chairman outlined the amount we have in the bank and on hand: €680 in the bank and €105 in cash. In the month of August, 125 euros were realized, even though a meeting was not possible due to conflicts in schedules/other obligations.

            Ugo accepted to communicate to  Chuks to help solve signatories also Francis advice and accept to join them and everyone accepted the idea. Kingsley thanks ugo and Francis for the effort pledged. Kingsley explained how he dealt with the 50 euros Chuks thought he owns and ask anyone to refer to the minutes of during that period if any one is in doubt. Chairman thanks Kingsley for the explanation and apologies to him and Chuks in any both understand the message. 
 ...
 */}
         <div className='minutes-buttons'>
          ...
          <BUTTON className='constution shadow-none border-none outline-line px-5 py-2 text-decoration-none text-light text-center '
          as={Link} to='/Minutes'>
