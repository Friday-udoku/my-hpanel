      ...
      <Container className=' fluid minutes-pages'>
          ...
          <div className = 'minutes-text text-dark '>
            <TextPage className='py-5 relative top-20 bottom-20 pb-10 w-100'>
                ...
                <p><strong>Absentees:</strong> Chijioke and Eloka</p>

                <p><strong>Proceedings:</strong> The previous minutes were read by Francis and the current minutes were taken by Charles Obodoechina. Chairman in his opening speech thank everyone that were present for fulfilling the obligation as a full member of this association,
                  Chairman expressed vote of thanks to all that participated in the Relay for life event we attended and asked if we have any feedback from the Organizers.
