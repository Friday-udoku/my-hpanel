...
const Video = () => {
  ...
  return (
    <VIDEO className="section-5-container section-container mt-10 text-dark
    " id="section-5">
    <div className="container">
        ...
        <div className="row">
            <div className="col section-bottom-button wow fadeInUp" id='gallary'>
                <button className="btn btn btn-customised btn-outline px-3 py-1 " 
                href="#" role="button" 
                style={{border: '2px solid #1e154e',
                borderRadius:'10px', fontWeight:'700',
                color:'#1e154e' }} onClick={onNavigation}>
