          ...
          <div className="row g-0">
            ...
            <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                ...
                <p className="small mb-0">The sustainable future of humanity is not a difficult issue if a culture that values human nature can be developed. Everyone is a human being in God's eyes and deserves to be treated as such regardless of color, race, or gender</p>
              </div>
            </div>
          </div>
        </div>
